...
// src/routes/food.ts
function food_default(app) {
  return __async(this, null, function* () {
    app.addHook("preHandler", checkSessionUser);
    app.get("/all", (req) => __async(this, null, function* () {
    ...
    app.get("/:id", (req) => __async(this, null, function* () {
      const userSession = req.cookies.sessionId;
    ...
    app.post("/create", (req) => __async(this, null, function* () {
      const userSession = req.cookies.sessionId;
      const foodSchema = import_zod2.z.object({
        name: import_zod2.z.string(),
        description: import_zod2.z.string(),
        is_diet: import_zod2.z.boolean()
      });
    ...
    app.delete("/delete/:id", (req) => __async(this, null, function* () {
      const paramsSchema = import_zod2.z.object({
        id: import_zod2.z.string()
      });
      const { id } = paramsSchema.parse(req.params);
    ...
    app.put("/update/:id", (req) => __async(this, null, function* () {
      const paramsSchema = import_zod2.z.object({
        id: import_zod2.z.string()
      });
      const { id } = paramsSchema.parse(req.params);
